							...
							<Col xs={12} md={12} xl={7}>
								<div className=" intro-content">
									...
									<p>
										...
										management, operating system and Data
										Structures, I have a strong aptitude for
										troubleshooting and finding and fixing
										bugs that can cause the code to break.
										As a college student, I gained strong
										hands-on coding and problem-solving
										experience as an{" "}
										<span>
											Information Technological Major
										</span>
										. I am very passionate about the
										opportunity to work on complex
										challenges and enjoy every process of
