									...
									<div className="general">
										...
										<div className="project-content">
											...
											<p className="project-presented">
												...
												Resonate Hackathon and came 2nd
												place.
											</p>
											<div>
												<span>
									...
									<div className="overlay">
										...
										>
											...
											<div className="coords">
												<p>
													Aidway provides an easy to
													use method for the victims
													to contact an emergency
													service and then track how
													far this help is from them.
													As soon as the victim sends
													a distress call, it is
								...
								>
									...
									<div className="overlay">
										...
										>
											...
											<div className="coords">
												<p>
													This software quickly
													generates a description of
													the image feeded into it and
													also provides the capability
													to hear the generated
													description. It was built to
													help the differently abled
													people and can also be
													enhanced for real time
													videos.
												</p>
											</div>
										</div>
										...
										>
											...
											<div className="coords">
												<p>
													...
													user can chats, Video call
													with the additional feature
													of Notepad where Users can
								...
								>
									<div className="general">
										...
										<div className="project-content">
											...
											<p className="project-presented">
												Project was presented at
												Abhigyan Hackathon and came 2nd
												place.
											</p>
											<div>
												<span>
									...
									<div className="overlay">
										...
										>
											...
											<div className="coords">
												<p>
													This apps is built for
													foodies and recommends
													Restaurants to the users
													based on their mood and
													preference. Also, in this
													COVID-19 pandemic users can
													view restaurants in 360° VR
													views sitting at Home and
													experience the digital view.
												</p>
											</div>
										</div>
									</div>
